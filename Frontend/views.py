...
class FrontendSetupView(APIView):
    @swagger_auto_schema(
        ...
        request_body=openapi.Schema(
            ...
            properties={
                ...
                'tech_stack_name': openapi.Schema(type=openapi.TYPE_ARRAY, items=openapi.Items(type=openapi.TYPE_STRING), description='선택한 기술스택의 세부 기술스택 리스트트'),
            },
    ...
    def post(self, request):
        ...
        # tech_stack_type이 1(프론트엔드)이 아니면 에러 반환
        if tech_stack_type != "1":
            return Response(
                {"error": "Invalid tech stack type. Only type '1' (frontend) is supported."},
        ...
        try:
            ...
            response = requests.post(
                ...
                json={
                    ...
                    "frontend_template": '-'.join(tech_stack_name),  # 예: "react-typescript-npm-vite"
                    "private": False
                },
