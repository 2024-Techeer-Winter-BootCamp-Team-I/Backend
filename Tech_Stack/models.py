...
class ProjectTech(models.Model):
    ...
    project = models.ForeignKey('login.Project', on_delete=models.CASCADE, verbose_name='프로젝트 아이디', null=False)
    tech = models.ForeignKey(TechStack, on_delete=models.CASCADE, verbose_name='기술 스택 아이디', null=False)
